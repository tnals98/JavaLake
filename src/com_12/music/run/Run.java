package com_12.music.run;

import java.util.List;
import java.util.Scanner;

import com_12.music.controller.MusicController;
import com_12.music.model.vo.Music;
import com_12.music.view.MusicView;
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				view.displaySuccess("마지막위치에 추가 성공!");
				break;
			case 2:
				music = view.inputMusicInfo();
				mController.addAtZreo(music);
				view.displaySuccess("첫위치에 추가 성공!");
				break;
			case 3:
