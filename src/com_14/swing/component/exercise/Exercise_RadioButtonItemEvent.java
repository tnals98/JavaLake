...
public class Exercise_RadioButtonItemEvent extends JFrame {
	...
	private ImageIcon[] images = { new ImageIcon("images/apple.jpg"), new ImageIcon("images/pear.jpg"),
			new ImageIcon("images/cherry.jpg") }; // 이미지 라벨에 들어갈 
	...
	public Exercise_RadioButtonItemEvent() {
		...
		JPanel radioPanel = new JPanel(); // 라디오 버튼을 추가할 팬을 만듦(이후 라디오 팬이라고 함)
		radioPanel.setBackground(Color.LIGHT_GRAY); // 새로 만든 라디오 팬의 배경색을 바꿈
...
//					}
		...
		c.add(radioPanel, BorderLayout.NORTH); // 라디오팬을 컨텐트팬에 추가함. 찹으로 붙여서 보일거임
